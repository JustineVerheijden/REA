...
describe('Data Service', function(){
	...
	beforeEach(inject(function(_$q_, _$httpBackend_, _constants_,_dataService_) {
    ...
    describe('Get All Properties function', function(){
	    it('should return all properties', function() {
		    ...
		    $httpBackend.when('GET', constants.propertiesURL)
    ...
    describe('Get Results Properties function', function(){
        it('should return only results properties', function() {
            ...
            dataService.getResultsProperties(response).then(function(data){
                return;
            });            
            $httpBackend.flush();
