...
describe('Saved Property Display', ()=> {
    ...
    it('should display expected logo on first saved property', ()=> {
        browser.waitForAngular();
        expect(mainPage.savedProperties.get(0).element(by.css('.agencyLogo')).getAttribute('src')).toMatch(mainPage.savedFirstImage);
    });

    it('should display expected background color on first saved property', ()=> {
        browser.waitForAngular();
    ...
    it('should display expected property image on first saved property', ()=> {
        browser.waitForAngular();
    ...
    it('should display expected price on first saved property', ()=> {
        browser.waitForAngular();
